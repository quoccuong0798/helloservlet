                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <p style="color: red">${response}</p>
                            <form action="${pageContext.request.contextPath}/job-details-update" method="POST" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly value="${tasksModel.getJobName() }"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id" value="${tasksModel.getId()}">	
                                        ...
                                        <a href="${pageContext.request.contextPath}/job-details?idJob=${tasksModel.getIdJob()}" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
