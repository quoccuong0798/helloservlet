                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <form  action="${pageContext.request.contextPath}/user-add" method="POST"class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">First Name</label>
                                    <div class="col-md-12">
                                        <input name="firstname"type="text" placeholder="Johnathan Doe"
